...
CREATE TABLE public.galaxy (
    galaxy_id integer NOT NULL, name character varying(40), shape character varying(30)
);
...
CREATE TABLE public.planet (
    planet_id integer NOT NULL, name character varying(30), description text, year_in_earth_days numeric(10, 2), has_moons boolean, star_id integer
);
...
CREATE TABLE public.star (
    star_id integer NOT NULL, name character varying(30), radius_in_km integer, galaxy_id integer
);
...
INSERT INTO
    public.galaxy
VALUES (
        11, 'Small Magellanic Cloud', 'Irregular'
    );
